    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="6">
          ...
          />
          <img src="/imgs/3.png" />
          <showBonusDetails chapterNumber="2" />
        </v-col>
        <v-col cols="12" md="6">
          ...
          <p>
            ...
            you are already proving popular amongst the students and the
            staff.<br />
            There are a few puzzles to solve and tasks to perform.<br /><br />

            Jodie, Annie and Maria already want to push your buttons.
            <br /><br />
            Be careful though, Principal Valentine could fire you if she catches
            you crossing any lines!
            <br /><br />
            Stay lucky!
            <br /><br />
            <b>Chapter Two</b> statistics : 1070 pages : 1195 images : 2 bonus
            scenes : 50 achievements : 10 bonus achievements : 100% free to play content
            <br />
