    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="6">
          ...
          />
          <img src="/imgs/15.png" />
          <showBonusDetails chapterNumber="7" />
        </v-col>
        <v-col cols="12" md="6">
          ...
          <p>
            ...
            Miss Goodhead and Governor Ramsey are here to inspect the facilities
            and pass judgement on everybody's performance.
            <br /><br />
            You must choose where your loyalties lie...
            <br /><br />
            Do you help Bridgette and Didi bring down the Principal? Does she
            have any other enemies or allies...?
            <br /><br />
            Of course, the day isn't all about cunning plots and schemes, you
            have a host of other distractions to keep you motivated too!
            <br /><br />
            Some of the relationships you have fostered over the past few days
